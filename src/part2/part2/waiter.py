...
class WaiterNode(Node):
    def __init__(self):
        ...
        ### CHANGES TO FOCUS ON
        self.declare_parameter('menu_items', ['Pizza', 'Pasta', 'Burger']) # Declare the parameter along with a default value
        self.menu = self.get_parameter('menu_items').get_parameter_value().string_array_value # Getting the value from the parameter
        ###
