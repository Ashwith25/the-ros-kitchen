...
class ChefNode(Node):
    def __init__(self):
        ...
        '''
            TASK 1
        '''
        self.declare_parameter('cooking_time', 2) # Declare the parameter along with a default value
        self.cooking_time = self.get_parameter('cooking_time').get_parameter_value().integer_value # Getting the value from the parameter
